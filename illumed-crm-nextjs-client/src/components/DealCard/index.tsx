...
/*     onClick={router.push(`/funnel/${id}`)}
 */    return (
        <Link href={`/funnel/${id}`} >
            <div className="grid grid-cols-2 bg-sidebar-block-color rounded-3xl h-[100px] px-4 py-2 text-center text-sidebar-text-color" onClick={handleSubmit}>
